...
export function Hero() {
  return (
    <section className="relative pt-24 md:pt-36">
      ...
      <div 
        aria-hidden
        className="absolute inset-0 -z-20 hidden opacity-65 lg:block"
      >
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
          ...
          <div className="mt-12 flex flex-col items-center justify-center gap-2 md:flex-row">
            <AnimatedGroup className="bg-foreground/10 rounded-[calc(var(--radius-xl)+0.125rem)] border p-0.5">
      ...
      <AnimatedGroup className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
        ...
        <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
          ...
          />
          <Image
            className="border-border/25 aspect-15/8 relative z-10 rounded-2xl border dark:hidden"
            src="/mail2-light.png"
            alt="app screen"
            width={2700}
            height={1440}
